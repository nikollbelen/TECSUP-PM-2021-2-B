...
class Respuesta : Fragment() {
    ...
    override fun onCreateView(
        ...
        var numero1 = view.findViewById<TextView>(R.id.numero1)
        var numero2 = view.findViewById<TextView>(R.id.numero2)
        var operacion = view.findViewById<TextView>(R.id.operacion)
        var rpta = view.findViewById<TextView>(R.id.respuesta)
        if (arguments != null) {
            val num1 = arguments!!.getString("num1")
            val num2 = arguments!!.getString("num2")
            val respuesta = arguments!!.getString("rpta")
            val ope = arguments!!.getString("operacion")
            numero1.text=num1
            numero2.text=num2
            operacion.text=ope
            rpta.text=respuesta
